    ...
    route("/api/chat") {
        authenticate("auth-jwt") {
            ...
            post("/conversations") {
                ...
                val conversationId =
                        chatService.createOrGetConversation(userId, request.otherUserId)

                call.respond(HttpStatusCode.OK, mapOf("conversationId" to conversationId))
            }
            ...
            post("/messages") {
                ...
                val message =
                        chatService.sendMessage(request.conversationId, userId, request.content)
